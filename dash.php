...
<body data-new-gr-c-s-check-loaded="14.1060.0" data-gr-ext-installed="">
  <div class="page">
    ...
    <section class="main">
      ...
      //$sql2 = "SELECT * FROM `orders` WHERE student_id = '$studentno' "; $result1 = mysqli_query($con, $sql2);
          ...
          <tbody>
            ...
            if (mysqli_num_rows($selectRes) == 0) {
              ...
              while ($row = mysqli_fetch_assoc($selectRes)) {
                ...
                echo "<ul><li><div>{$row['id']}</div><div>{$row['username']}</div><div>{$row['password']}</div></li></ul>\n";
